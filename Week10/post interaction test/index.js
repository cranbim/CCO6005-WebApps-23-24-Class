...
app.get('/like', checkLoggedIn, async (request, response)=>{
    ...
    let retrievedPost=await postData.likePost(postID)
    // console.log(retrievedPost)
    response.render('pages/app', {
        username: request.session.userid,
        isLoggedIn: checkLoggedInState(request),
...
app.get('/likeComment', checkLoggedIn, async (request, response)=>{
    let postID=request.query.postid
    let commentIndex=request.query.commentindex
    console.log(postID, commentIndex)
    let retrievedPost=await postData.likeComment(postID,commentIndex)
    // console.log(retrievedPost)
    response.render('pages/app', {
        username: request.session.userid,
        isLoggedIn: checkLoggedInState(request),
...
app.post('/comment', async (request, response)=>{
    ...
    response.redirect('/viewpost?postid='+commentedPostID)
})
